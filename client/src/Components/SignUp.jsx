...
function SignUp(){
    ...
    const paperStyle = {padding: "1rem", margin: "100px auto", borderRadius:"1rem", boxShadow: "10px 10px 10px", marginTop: "150px",};
    ...
    return (
        <div>
            <Grid align="center" className="wrapper">
                ...
                height:{
                    lg: '450px',     // 1200px and up
                }}}>
                    <Typography component="h1" variant="h5" style={heading} color="blueviolet"> Signup </Typography>
