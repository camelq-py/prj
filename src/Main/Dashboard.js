...
import ProfileImage from './V.png';
    ...
    return (
       ...
       <nav className="navbar">
                ...
                <ul className={`navbar-links ${isMobileMenuOpen ? 'open' : ''}`}>
                    ...
                    <li><a href="#team" onClick={handleLinkClick}>Teams</a></li>
                    <li><a href="#clients" onClick={handleLinkClick}>Clients</a></li>
                    <li><a href="#pricing" onClick={handleLinkClick}>Pricing</a></li>
                    <li><a href="#contact" onClick={handleLinkClick}>Contact</a></li>
                    <li><a href="#faqs" onClick={handleLinkClick}>FAQs</a></li>
                    <li><a href="#footer" onClick={handleLinkClick}>Visit Us</a></li>
                </ul>
                <div className="profile-container">
                    ...
                    {isDropdownOpen && (
                        <div className="profile-dropdown">
                            <button onClick={profilePage} className="profile-in">Profile</button>
      ...
      <div className="content">
        ...
        <div className="team-members">
          ...
          <div className="team-member">
            <img src="https://media.istockphoto.com/id/1413766112/photo/successful-mature-businessman-looking-at-camera-with-confidence.jpg?s=612x612&w=0&k=20&c=NJSugBzNuZqb7DJ8ZgLfYKb3qPr2EJMvKZ21Sj5Sfq4=" alt="John Doe" className="team-image" />
            <h3>John Doe</h3>
          ...
          {/* Founder Section */}
          <div className="team-member">
            <img src="https://t3.ftcdn.net/jpg/01/80/80/28/360_F_180802852_C3Zm4g9avBz5osPEA769dF0KKp5cQZYT.jpg" alt="Jane Smith" className="team-image" />
            <h3>Jane Smith</h3>
          ...
          {/* HR Section */}
          <div className="team-member">
            <img src="https://media.istockphoto.com/id/1299077558/photo/lead-yourself-to-a-life-of-success.jpg?s=612x612&w=0&k=20&c=OQZPSnM1Eq-4Xx8bxJE8KQ5olJFfRw_YMc29aQ0Au6U=" alt="Emily Johnson" className="team-image" />
            <h3>Emily Johnson</h3>
          ...
          {/* Instructor Section */}
          <div className="team-member">
            <img src="https://etimg.etb2bimg.com/photo/112106757.cms" alt="Michael Brown" className="team-image" />
            <h3>Michael Brown</h3>
